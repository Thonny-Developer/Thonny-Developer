...
I build backend systems, APIs, and automation tools.
Focused on clean architecture, scalability, and predictable behavior in production.

Portfolio  
https://thonny.pythonanywhere.com/
...
- REST APIs and async services
- AI / NLP experiments and model integration
- Bots and automation
- Working with databases and caching layers
